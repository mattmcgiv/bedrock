...
4. Add theme(s) in `htdocs/app/themes` as you would for a normal WordPress site.
4. Set your site vhost document root to `/path/to/site/htdocs/` (`/path/to/site/current/htdocs/` if using deploys)
